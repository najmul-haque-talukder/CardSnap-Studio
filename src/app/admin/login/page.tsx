  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-background relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-4">
        <Link 
          href="/" 
          className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors mb-2 ml-1"
        >
          <ArrowLeft className="w-4 h-4" /> Back to Website
        </Link>
        
        <Card className="border-border/50 shadow-2xl bg-card/80 backdrop-blur-sm rounded-2xl">
